		...
		<div class="row">
			<div class="col-md-6 mt-3">
				...
				<?php if($res): ?>
					...
					<p>
						<a href="editmarca.php?id=<?php echo $res['id']; ?>" class="btn btn-link">Editar</a>
				...
				<?php if(isset($prod) && count($prod)): ?>
					<table class="table table-hover">
						...
						<?php foreach($prod as $p): ?>
							<tr>
								<td>
									<a href="<?php echo BASE_URL . 'productos/verproducto.php?id=' . $p['id']; ?>"><?php echo $p['nombre']; ?></a>
								</td>
								<td><?php echo $p['codigo']; ?></td>
								<td><?php echo $p['categoria']; ?></td>
								<td>
									<?php if($p['active'] == 1): ?> Si <?php else: ?> No <?php endif; ?>
								</td>
							</tr>
						<?php endforeach; ?>
					</table>
