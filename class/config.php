<?php 
// <!-- configurar variables de entorno a traves del uso de constantes-->
define('BASE_URL', 'http://localhost/farmacia/');
define('BASE_IMG', 'http://localhost/farmacia/img');
define('BASE_CLASS', 'http://localhost/farmacia/class');
