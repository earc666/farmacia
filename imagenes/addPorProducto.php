	...
	//Guardamos el directorio y el archivo en una variable
		...
		if (move_uploaded_file($_FILES['imagen']['tmp_name'], $fichero_subido)){
			...
			if (!$sql) {
				...
				header('Location: ' . BASE_URL . 'productos/verProducto.php?id=' . $producto);
			}
		}else{
			...
			<div class="col-md-6 mt-3">
				...
				<form action="" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<a href="<?php echo BASE_URL . 'productos/verProducto.php?id=' . $producto; ?>" class="btn btn-link">Volver</a>
					</div>
				</form>
			</div>
		</div>
