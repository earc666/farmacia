			...
			<div class="col-md-6 mt-3">
				...
				<?php if($prod): ?>
					<table class="table table-hover">
						...
						<tr>
							<th>Activo:</th>
							<td><?php if($prod['active']==1): ?> Si <?php else: ?> No <?php endif; ?></td>
						</tr>
						<tr>
							<th>Descripcion:</th>
					...
					<p>
						<a href="editPRODUCTO.php?id=<?php echo $prod['id']; ?>" class="btn btn-link">Editar</a>
				...
				<?php if(isset($img) && count($img)): ?>
					<?php foreach($img as $img): ?>
						<div class="col-md-6">
							...
							<img style="width: 100%; height: 100%" src="<?php echo BASE_IMG . '/productos/' . $img['nombre']; ?>" > 
						</div>
					<?php endforeach; ?>
				<?php else: ?>
